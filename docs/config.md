# lehtiolab/nf-deqms: Configuration for other clusters
...
```bash
singularity pull --name nf-deqms.simg docker://lehtiolab/nf-deqms
```
...
```nextflow
singularity.enabled = true
process.container = "/path/to/nf-deqms.simg"
```
